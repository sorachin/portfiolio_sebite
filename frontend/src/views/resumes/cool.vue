<template>
  <div class="resume1">
    <div class="banner">
      <div class="banner__fullname" id="formdata.name" >{{ person.name.first }} {{ person.name.middle }} {{ person.name.last }}</div>
...
import formdata from '../../components/resume'
// const documentPath = 'Users/user'
const name = 'cool';

export default Vue.component(name, getVueOptions(name),formdata)
</script>
